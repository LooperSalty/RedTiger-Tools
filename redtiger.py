...
def Options():
    ...
    #   Number   Name                        Description                                                               Category      Function                Argument
        ...
        13    : ("Phone Numer Lookup",       "Retrieve public data from a phone number.",                              "Osint",      PhoneNumerLookup,       {"phone":    {"required": True, "nargs": 1, "help": "Phone number target: <number>"},                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "output": {"action": "store_true", "help": "Creating additional JSON output."}}),
